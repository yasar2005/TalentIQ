...
export const resultsAnalyticsArticles: DocArticle[] = [
  {
    ...
    content: () => (
      <>
        ...
        <h2>AI Analysis</h2>
        <p>
          After a candidate completes a session, TalentIQ automatically produces:
        </p>
        <ul>
        ...
        <p>
          TalentIQ analyzes the candidate&apos;s communication style across every response — detecting confidence level, tone consistency, and clarity. Each question is rated for tone (e.g., Confident, Neutral) and impact (High, Low), giving you a quick read on how the candidate communicates under interview conditions.
        </p>
