...
export const INTERVIEW_TEMPLATES: InterviewTemplate[] = [
  ...
  {
    id: "audio-interview",
    title: "Audio Response Interview",
    description: "Candidates answer by recording spoken audio — ideal for assessing communication, confidence, and presentation skills.",
    objective: "Evaluate verbal communication, articulation, and confidence through recorded audio answers that are automatically transcribed and scored.",
    icon: "Mic",
    aiTone: "PROFESSIONAL",
    followUpDepth: "MODERATE",
    assessmentCriteria: [
      { name: "Verbal Communication", description: "Speaks clearly, confidently, and at an appropriate pace." },
      { name: "Content Quality", description: "Answers are structured, relevant, and demonstrate depth of knowledge." },
      { name: "Professionalism", description: "Tone and language are appropriate for a professional setting." },
      { name: "Conciseness", description: "Delivers key points without unnecessary filler or rambling." },
    ],
    chatEnabled: true,
    voiceEnabled: true,
    videoEnabled: false,
    timeLimitMinutes: 25,
    questions: [
      { order: 0, text: "Introduce yourself and explain why you are the right fit for this role.", type: "OPEN_ENDED", probeOnShort: true, isRequired: true },
      { order: 1, text: "Describe a professional achievement you are most proud of and what made it successful.", type: "OPEN_ENDED", probeOnShort: true, isRequired: true },
      { order: 2, text: "How do you handle working under pressure or tight deadlines? Give a specific example.", type: "OPEN_ENDED", probeOnShort: true, isRequired: true },
      { order: 3, text: "Where do you see yourself professionally in the next 3 to 5 years?", type: "OPEN_ENDED", probeOnShort: false, isRequired: true },
      { order: 4, text: "Do you have any questions for us about the role or the team?", type: "OPEN_ENDED", probeOnShort: false, isRequired: false },
    ],
  },
];
